...
public class PerformanceMenuInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        Menu salary = ensureMenu("薪资管理", "/salary", "Money", 30, 0L);
        Menu performance = ensureMenu("绩效考核", "/salary/performance", "DataAnalysis", 33, salary.getId());

        attachMenus("ADMIN", salary, performance);
        attachMenus("HR", salary, performance);
    }
